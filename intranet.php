                ...
                <table class="table table-dark table-hover align-middle">
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                ...
                                <a href="intranet.php?delete=<?= (int) $film['idfilm'] ?>" class="btn btn-danger"onclick="return confirm('Supprimer ce film?')">Supprimer</a>
                            </td> 
                        </tr>
                       <?php } ?>
                    </tbody>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                ...
                                <a href="intranet.php?delete_salle=<?= (int) $salle['idsalle'] ?>" class="btn btn-danger" onclick="return confirm('Supprimer cette salle?')">
                            Supprimer
                                </a>
                            </td> 
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                ...
                                <a href="intranet.php?delete_seance=<?= (int) $seance['idseance'] ?>" class="btn btn-danger"onclick="return confirm('Supprimer cette                         seance?')">
Supprimer
</a>
                            </td> 
                        </tr>
